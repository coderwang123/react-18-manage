...
declare namespace Env {
  ...
  interface ImportMeta extends ImportMetaEnv {
    ...
    /** 在配置应用程序打包后是否自动检测更新 Whether to automatically detect updates after configuring application packaging */
    readonly VITE_AUTOMATICALLY_DETECT_UPDATE?: CommonType.YesOrNo;

    /** 应用程序的基础 URL The base url of the application */
    readonly VITE_BASE_URL: string;
    readonly VITE_CONSTANT_ROUTE_MODE: 'dynamic' | 'static';

    /**
     * 是否启用 HTTP 代理？ Whether to enable the http proxy
     *
     * 仅在开发环境中有效 Only valid in the development environment
     */
